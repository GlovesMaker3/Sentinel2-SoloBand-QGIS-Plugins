...
#Otwiera się cały czas
    ...
    def open_file(self, output_dir):
        print('open_file(output_dir)')
        full_path = os.path.abspath(output_dir)  # Pobierz pełną ścieżkę do folderu
        print(full_path)
        if os.path.exists(full_path):
            ...
            print(f'Folder nie istnieje: {full_path}')
...
###################### 10m ##############################
            ...
            if self.ALL_10m.isChecked():
                ...
                s3 = ['AOT_20m.jp2', 'B01_20m.jp2', 'B02_20m.jp2', 'B03_20m.jp2', 'B04_20m.jp2', 'B05_20m.jp2', 'B06_20m.jp2', 'B07_20m.jp2', 'B8A_20m.jp2',
                      'B11_20m.jp2', 'B12_20m.jp2', 'SCL_20m.jp2', 'TCI_20m.jp2', 'WVP_20m.jp2']
            else:
